...
| cancelOrder | response-200 | [response](../design/data-model/orders.schema.json#/$defs/response) | [FE](FE-001.md) [BE](BE-001.md) [SYNC](SYNC-001.md) | [valid](../design/data-model/response.json) | N/A |
