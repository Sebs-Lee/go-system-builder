...
> 层：第四层；版本：v1.0.0；设计基准：最新 Claude Code 官方机制。
>
...
| 日期 | 版本 | 变更依据 |
| --- | --- | --- |
| 2026-09-18 | 1.0.0 | 根目录 [`L4-worktree-hook-remediation.md`](../L4-worktree-hook-remediation.md) 与用户分支绑定、软提醒、上游输入来源要求；建立跨 Stage 唯一机制定义 |
